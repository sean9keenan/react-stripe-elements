      ...
      return {
        addElementsLoadListener: function addElementsLoadListener(fn) {
          ...
          if (_this2.context.tag === 'sync') {
            fn(_this2.context.stripe.elements(options));
          } else {
...
var Provider = function (_React$Component) {
  ...
  function Provider(props) {
    ...
    if (_this.props.apiKey && _this.props.stripe) {
      ...
      if (!window.Stripe) {
        throw new Error("Please load Stripe.js (https://js.stripe.com/v3/) on this page to use react-stripe-elements. If Stripe.js isn't available yet (it's loading asynchronously, or you're using server-side rendering), see https://github.com/stripe/react-stripe-elements#TODO");
      } else {
  ...
  _createClass(Provider, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!this._didWakeUpListeners && nextProps.stripe) {
        ...
        var _stripe = ensureStripeShape(nextProps.stripe);
        this._meta.stripe = _stripe;
...
var inject = function inject(WrappedComponent) {
  ...
  return _temp = _class = function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      key: 'stripeProps',
      value: function stripeProps(stripe) {
...
var Element = function Element(type) {
  ...
  return _temp = _class = function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      value: function _setupEventListeners(element) {
        var _this3 = this;
