...
describe('Element', function () {
  ...
  it('should call onReady and elementRef', function () {
    var CardElement = (0, _Element2.default)('card', { sourceType: 'card' });
    var onReadyMock = jest.fn();
    var elementRefMock = jest.fn();
    (0, _enzyme.mount)(_react2.default.createElement(CardElement, { onReady: onReadyMock, elementRef: elementRefMock }), {
      context: context
    });
  ...
  it.only("re-rendering with new props should still work if addElementsLoadListener hasn't fired yet", function () {
